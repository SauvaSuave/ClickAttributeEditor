...
- Field selection (change target field with SHIFT + left-click)
...
WINDOW_TITLE = "Edit attribute (on left-click)"
...
class ClickEditTool(QgsMapToolIdentify):
    ...
    def canvasReleaseEvent(self, event):
        ...
        # SHIFT + left-click = quickly change target field
...
class ClickAttributeEditor:
    ...
    def initGui(self):
        ...
        self.action.setToolTip(
            "ClickAttributeEditor: left-click a feature to edit a field "
            "(SHIFT + left-click to change the target field)."
        )
    ...
    def choose_field(self, layer) -> bool:
        ...
        choice, ok = QInputDialog.getItem(
            self.iface.mainWindow(),
            "Choose field",
            "Which field should be edited on left-click? (SHIFT + left-click changes it quickly)",
            fields,
